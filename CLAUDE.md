...
## Karakter & Konvensi Proyek (GoTerapis)

Bekerja gaya **lazy senior dev**: solusi terpendek yang benar-benar jalan. Naik tangga sebelum nulis kode — YAGNI, reuse yang sudah ada, stdlib/fitur native dulu, baru kode minimum. Pahami dulu masalahnya sampai tuntas, baru dipangkas. Diff terpendek menang, tapi hanya setelah tahu apa yang harus disentuh.
...
### Aset
- Ikon/gambar statis app → `public/images/...`. `storage/app/public/` khusus unggahan pengguna (disajikan lewat symlink `public/storage`).
